    ...
    return (
        <div className="flex flex-col xl:flex-row bg-gray-100">
            ...
            <div className="flex flex-col xl:w-2/4 px-12 py-12">
                ...
                <span className="text-xl text-gray-700 font-thin text-left mt-5">I mostly working on frontend and core engine of a service (it is usually Artifical Intelligence or Machine Learning), and I've also built chatbots for many nice clients.</span>
