        ...
        <div className="flex flex-col justify-items-center">
            ...
            <div className="flex flex-col mx-auto mt-32 px-16">
                ...
                <div className="flex flex-col md:flex-row mx-auto">
                    <a className="flex flex-row shadow-xl bg-bunker-500 hover:bg-bunker-100 px-8 py-5 rounded-full text-white font-title font-thin mx-1 my-1 text-center" href="https://github.com/dkhd" target="_blank" rel="noreferrer">
                    ...
                    <a className="flex flex-row shadow-xl bg-blue-chill-500 hover:bg-blue-chill-400 px-8 py-5 rounded-full text-white font-title font-thin mx-1 my-1 text-center" href="https://linkedin.com/in/dikyhadna" target="_blank" rel="noreferrer">
                    ...
                    <a className="flex flex-row shadow-xl bg-japanese-laurel-500 hover:bg-japanese-laurel-400 px-8 py-5 rounded-full text-white font-title font-thin mx-1 my-1 text-center" href="https://www.upwork.com/freelancers/~010bc381d70641ac36" target="_blank" rel="noreferrer">
                    ...
                    <a className="flex flex-row shadow-xl bg-black hover:bg-gray-500 px-8 py-5 rounded-full text-white font-title font-thin mx-1 my-1 text-center" href="https://medium.com/@dkhd" target="_blank" rel="noreferrer">
                        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
                    ...
                    <a className="flex flex-row shadow-xl bg-yellow-500 hover:bg-yellow-400 px-8 py-5 rounded-full text-white font-title font-thin mx-1 my-1 text-center" href="https://www.buymeacoffee.com/dkhd" target="_blank" rel="noreferrer">
