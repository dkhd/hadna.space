...
const BuildThings = (() => {
    ...
    return (
      <div className="flex flex-col xl:flex-row bg-nord-nord2">
        ...
        <div className="xl:w-2/4">
          <figure className=" relative w-full h-full">
            <img
              ...
              src={process.env.PUBLIC_URL + "/image/macbook.jpg"}
              ...
              <div>
                <h1 className="text-sm">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    &copy; Christopher Gower — Unsplash
                  </a>
                </h1>
              </div>
            </figcaption>
