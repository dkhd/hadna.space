    ...
    <div className="flex flex-col justify-center py-20">
      <div className="px-5 md:px-16 mx-auto">
        ...
        <p className="text-2xl text-gray-700 font-light text-gray-700 text-center mt-3 md:w-6/12 mx-auto mt-10">
          My first introduction to OSS (Open Source Software) was in 2007 when I was a high school student. Since then, I developed a special interest in using OSS and it helped me in so many ways to become who I am today. Now, I want to return the favor by contributing to OSS. And while
        ...
        <p className="text-2xl text-gray-700 font-light text-gray-700 text-center mt-3 md:w-6/12 mx-auto mt-10">
          ...
          and drop stars to my public repositories. You can also help me to expand the list above by giving me a suggestion to an OSS project you already know or use (or if you are a maintainer of an OSS project and need help, ping me!). <br/><br/>In the meanwhile, these are my Github stats generated
          from{" "}
          <a
