        ...
        <div className="grid justify-items-start md:justify-items-center px-12 py-12">
            ...
            {/* <div className="mx-auto mt-20 py-5" onMouseEnter={showTippy} onMouseLeave={hideTippy}>
                <Tippy 
                    ...
                    content={
                        <div className="bg-dkhd-purple text-white font-base px-3 py-3 rounded-md" onMouseEnter={showTippy}>
                    ...
                    <div className="shadow-xl bg-dkhd-purple hover:bg-dkhd-purple-200 px-8 py-5 rounded-full text-dkhd-purple-200 hover:text-dkhd-purple font-semibold tracking-widest" onClick={showTippy}>📫 &nbsp; {emailAddress}</div>
                </Tippy>
            </div> */}
        </div>
    )
