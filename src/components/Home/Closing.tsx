...
const Closing = (() => {
    ...
    return (
        <div className="grid justify-items-start md:justify-items-center px-12 py-12">
            ...
            <span className="text-4xl text-gray-700 mt-7 font-thin text-left md:text-center">I look forward to hear from you!</span>
            <div className="mt-20 py-5" onMouseEnter={showTippy} onMouseLeave={hideTippy}>
                <Tippy 
                    placement="top"
                    interactive={true}
