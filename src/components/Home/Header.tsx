...
const Header = (() => {
    ...
    return (
        <div className="grid justify-items-start md:justify-items-center px-12 py-12">
            ...
            <h1 className="max-w-screen-lg text-6xl sm:text-8xl xl:text-9xl text-gray-700 mt-7 font-bold md:tracking-tighter text-left md:text-center">AI/ML & Frontend Developer</h1>
            ...
            <div className="mx-auto mt-20 pb-5" onMouseEnter={showTippy} onMouseLeave={hideTippy}>
                <Tippy 
                    ...
                    <div className="flex flex-row justify-center shadow-xl bg-radical-red-500 hover:bg-radical-red-400 px-8 py-5 rounded-full text-white font-semibold tracking-widest" onClick={showTippy}>📫 &nbsp; {emailAddress}</div>
                </Tippy>
            </div>
        </div>
    )
