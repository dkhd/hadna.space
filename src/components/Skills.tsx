            ...
            <div className="flex flex-col xl:w-2/4 px-12 py-12">
                ...
                <span className="flex flex-row content-center ml-3 mt-3">
                    ...
                    <span className="self-center ml-3 text-gray-500">
                        Known for its <a className="text-radical-red-500 underline hover:text-radical-red-300" href="https://en.wikipedia.org/wiki/Special_Region_of_Yogyakarta" target="_blank" rel="noreferrer">cultural heritage</a>
                    </span>
                </span>
                ...
                <span className="text-xl text-gray-700 font-thin text-left mt-5">I mostly working on frontend, backend, and core engine of a service. But that doesn't stop me from exploring latest things like Artifical Intelligence and Machine Learning. And oh, I've also built chatbots for many nice clients.</span>
                <span className="text-xl text-gray-700 font-thin text-left mt-5">While I might not list them all here, but here are several things I'm familiar with: ReactJS, NextJS, GatsbyJS, VueJS, TailwindCSS, Typescript, NodeJS, ExpressJS, Python, Flask, Pandas, OpenCV, and MongoDB.</span>
                <span className="text-xl text-gray-700 font-thin text-left mt-5">Not seeing your required stacks listed? <a href="mailto:hi@hadna.space" className="text-radical-red-500 underline hover:text-radical-red-300">Say hi!</a> Maybe I forgot to write them down?</span>
            </div>
        </div>
    )
})
